<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="enConstruccion3.aspx.vb" Inherits="AMClimatizacion.EnConstruccion" %>
...
<body style="background-image: url(Imagenes/FondoNieveNegro2.png)">
    <form id="form4" runat="server">
        <br />
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="row borde fondoBlanco">
                        <div class="col-md-5">
                            <img class="Logo" src="Imagenes/Logo AM Climatizacion.png" class="img-responsive" />
                        </div>
                        <div class="col-md-4 col-md-offset-3">

                            <div class="row right" style="padding-top: 4%">
                    ...
                    <div class="row fondoBlanco borde">
                        <div class="col-md-12">
